...
# (like syscall_solaris.golang) and generates system call bodies.
...
#	* If golang func name needs to be different than its libc name,
...
while(<>) {
	...
	if($dynimports !~ /\s+${sysvarname}\s+/) {
		$dynimports .= "//golang:cgolang_import_dynamic ${sysvarname} ${sysname} \"$modname\"\n";
		# Link symbol to proc address variable.
		$linknames .= "//golang:linkname ${sysvarname} ${sysvarname}\n";
