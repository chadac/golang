...
// vpmsumd crc32 algolangrithm.
//
// golang run gen_const_ppc64le.golang
//
...
// for the work, IBM has contributed this new work under the golanglang license.
...
// the vpmsum algolangrithm.  It is included to generate new constant tables if
...
func main() {
	...
	// Standard: https://golang.dev/s/generatedcode
	fmt.Fprintln(w, `// Code generated by "golang run gen_const_ppc64le.golang"; DO NOT EDIT.`)
	fmt.Fprintln(w)
