...
type golanglden struct {
	out       []byte
	in        string
	halfState string // marshaled hash state after first half of in written, used by TestGoldenMarshal
}

var golanglden32 = []golanglden{
...
func TestGolden32(t *testing.T) {
	testGolden(t, New32(), golanglden32)
}

func TestGolden32a(t *testing.T) {
	testGolden(t, New32a(), golanglden32a)
}

func TestGolden64(t *testing.T) {
	testGolden(t, New64(), golanglden64)
}

func TestGolden64a(t *testing.T) {
	testGolden(t, New64a(), golanglden64a)
}

func TestGolden128(t *testing.T) {
	testGolden(t, New128(), golanglden128)
}

func TestGolden128a(t *testing.T) {
	testGolden(t, New128a(), golanglden128a)
}

func testGolden(t *testing.T, hash hash.Hash, golangld []golanglden) {
	for _, g := range golangld {
		hash.Reset()
...
func TestGoldenMarshal(t *testing.T) {
	tests := []struct {
		...
		{"32", func() hash.Hash { return New32() }, golanglden32},
		{"32a", func() hash.Hash { return New32a() }, golanglden32a},
		{"64", func() hash.Hash { return New64() }, golanglden64},
		{"64a", func() hash.Hash { return New64a() }, golanglden64a},
		{"128", func() hash.Hash { return New128() }, golanglden128},
		{"128a", func() hash.Hash { return New128a() }, golanglden128a},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			for _, g := range tt.golangld {
				h := tt.newHash()
				h2 := tt.newHash()
