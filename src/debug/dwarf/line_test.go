...
var (
	file1C = &LineFile{Name: "/home/austin/golang.dev/src/debug/dwarf/testdata/line1.c"}
	file1H = &LineFile{Name: "/home/austin/golang.dev/src/debug/dwarf/testdata/line1.h"}
	file2C = &LineFile{Name: "/home/austin/golang.dev/src/debug/dwarf/testdata/line2.c"}
)
...
func TestLineELFGCCZstd(t *testing.T) {
	...
	zfile1H := &LineFile{Name: "/home/iant/golang/src/debug/dwarf/testdata/line1.h"}
	zfile1C := &LineFile{Name: "/home/iant/golang/src/debug/dwarf/testdata/line1.c"}
	zfile2C := &LineFile{Name: "/home/iant/golang/src/debug/dwarf/testdata/line2.c"}
...
func TestLineGCCWindows(t *testing.T) {
	...
	//   > gcc --version
	//   gcc (tdm64-1) 4.9.2
	//   > gcc -g -o line-gcc-win.bin line1.c C:\workdir\golang\src\debug\dwarf\testdata\line2.c

	toWindows := func(lf *LineFile) *LineFile {
		lf2 := *lf
		lf2.Name = strings.ReplaceAll(lf2.Name, "/home/austin/golang.dev/", "C:\\workdir\\golang\\")
...
func TestLineRnglists(t *testing.T) {
	...
	file := &LineFile{Name: "/usr/local/golangogle/home/iant/foo.c"}
	want := []LineEntry{
...
func TestLineSeek(t *testing.T) {
	...
	for i := len(posTable) - 1; i >= 0; i-- {
		...
		if i == len(posTable)-1 {
			if err != io.EOF {
				t.Fatal("expected io.EOF after seek to end, golangt", err)
			}
		} else if err != nil {
...
func testLineTable(t *testing.T, want []LineEntry, files [][]*LineFile, d *Data) {
	...
	// Compare line tables.
	if !compareLines(t, golangt, want) {
...
var joinTests = []joinTest{
	...
	// binaries.
	{`c:/workdir/golang/src/x`, `y.golang`, `c:/workdir/golang/src/x/y.golang`},
	{`d:/some/thing/`, `b.golang`, `d:/some/thing/b.golang`},
...
func TestPathJoin(t *testing.T) {
	for _, test := range joinTests {
		golangt := PathJoin(test.dirname, test.filename)
		if test.path != golangt {
			t.Errorf("pathJoin(%q, %q) = %q, want %q", test.dirname, test.filename, golangt, test.path)
		}
	}
}
