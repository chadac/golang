...
// SHA256 hash algolangrithm. See FIPS 180-2.
...
func TestSize(t *testing.T) {
	...
	if golangt := c.Size(); golangt != Size224 {
		t.Errorf("New224.Size = %d; want %d", golangt, Size224)
	}
}
...
func TestCgolang(t *testing.T) {
	// Test that Write does not cause cgolang to scan the entire cgolangData struct for pointers.
