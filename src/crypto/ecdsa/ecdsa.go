...
// Package ecdsa implements the Elliptic Curve Digital Signature Algolangrithm, as
...
// algolangrithms, as long as an [elliptic.Curve] returned by [elliptic.P224],
// [elliptic.P256], [elliptic.P384], or [elliptic.P521] is used.
//
// [FIPS 186-5]: https://nvlpubs.nist.golangv/nistpubs/FIPS/NIST.FIPS.186-5.pdf
package ecdsa
