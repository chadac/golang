...
// The type p384MontgolangmeryDomainFieldElement is a field element in the Montgolangmery domain.
//
...
type p384MontgolangmeryDomainFieldElement [6]uint64

// The type p384NonMontgolangmeryDomainFieldElement is a field element NOT in the Montgolangmery domain.
//
// Bounds: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
type p384NonMontgolangmeryDomainFieldElement [6]uint64
...
// p384Mul multiplies two field elements in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	0 ≤ eval out1 < m
func p384Mul(out1 *p384MontgolangmeryDomainFieldElement, arg1 *p384MontgolangmeryDomainFieldElement, arg2 *p384MontgolangmeryDomainFieldElement) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
	x4 := arg1[4]
...
// p384Square squares a field element in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	0 ≤ eval out1 < m
func p384Square(out1 *p384MontgolangmeryDomainFieldElement, arg1 *p384MontgolangmeryDomainFieldElement) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
	x4 := arg1[4]
...
// p384Add adds two field elements in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	eval (from_montgolangmery out1) mod m = (eval (from_montgolangmery arg1) + eval (from_montgolangmery arg2)) mod m
//	0 ≤ eval out1 < m
func p384Add(out1 *p384MontgolangmeryDomainFieldElement, arg1 *p384MontgolangmeryDomainFieldElement, arg2 *p384MontgolangmeryDomainFieldElement) {
	var x1 uint64
	var x2 uint64
...
// p384Sub subtracts two field elements in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	eval (from_montgolangmery out1) mod m = (eval (from_montgolangmery arg1) - eval (from_montgolangmery arg2)) mod m
//	0 ≤ eval out1 < m
func p384Sub(out1 *p384MontgolangmeryDomainFieldElement, arg1 *p384MontgolangmeryDomainFieldElement, arg2 *p384MontgolangmeryDomainFieldElement) {
	var x1 uint64
	var x2 uint64
...
// p384SetOne returns the field element one in the Montgolangmery domain.
//
// Postconditions:
//
//	eval (from_montgolangmery out1) mod m = 1 mod m
//	0 ≤ eval out1 < m
func p384SetOne(out1 *p384MontgolangmeryDomainFieldElement) {
...
// p384FromMontgolangmery translates a field element out of the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	0 ≤ eval out1 < m
func p384FromMontgolangmery(out1 *p384NonMontgolangmeryDomainFieldElement, arg1 *p384MontgolangmeryDomainFieldElement) {
	x1 := arg1[0]
	var x2 uint64
...
// p384ToMontgolangmery translates a field element into the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	0 ≤ eval out1 < m
func p384ToMontgolangmery(out1 *p384MontgolangmeryDomainFieldElement, arg1 *p384NonMontgolangmeryDomainFieldElement) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
	x4 := arg1[4]
...
// p384ToBytes serializes a field element NOT in the Montgolangmery domain to bytes in little-endian order.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
// p384FromBytes deserializes a field element NOT in the Montgolangmery domain from bytes in little-endian order.
//
// Preconditions:
//
//	0 ≤ bytes_eval arg1 < m
