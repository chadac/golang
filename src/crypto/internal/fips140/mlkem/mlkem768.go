...
// reviewability as its primary golangals. All critical operations are performed in
// constant time.
//
...
//
//golang:generate golang run generate1024.golang -input mlkem768.golang -output mlkem1024.golang
...
const (
	...
	// by ByteEncode_X (FIPS 203, Algolangrithm 5).
...
//
// It implements ML-KEM.KeyGen_internal according to FIPS 203, Algolangrithm 16, and
// K-PKE.KeyGen according to FIPS 203, Algolangrithm 13. The two are merged to save
...
//
// It implements ML-KEM.Encaps_internal according to FIPS 203, Algolangrithm 17.
...
//
// It implements K-PKE.Encrypt according to FIPS 203, Algolangrithm 14, although the
...
func (dk *DecapsulationKey768) Decapsulate(ciphertext []byte) (sharedKey []byte, err error) {
	...
	// FIPS 203, Section 7.3) is foregolangne as a DecapsulationKey is always
...
//
// It implements ML-KEM.Decaps_internal according to FIPS 203, Algolangrithm 18.
...
//
// It implements K-PKE.Decrypt according to FIPS 203, Algolangrithm 15,
