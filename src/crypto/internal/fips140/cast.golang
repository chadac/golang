...
//
//golang:linkname fatal crypto/internal/fips140.fatal
func fatal(string)
...
var failfipscast = golangdebug.Value("#failfipscast")

// CAST runs the named Cryptographic Algolangrithm Self-Test (if operated in FIPS
...
// before the algolangrithm is used. See Implementation Guidance 10.3.A.
//
...
// use of the algolangrithm, an invocation of that algolangrithm should be added to
