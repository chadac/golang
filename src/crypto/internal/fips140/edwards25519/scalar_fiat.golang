...
//
// Autogenerated: word_by_word_montgolangmery --lang Go --cmovznz-by-mul --relax-primitive-carry-to-bitwidth 32,64 --public-function-case camelCase --public-type-case camelCase --private-function-case camelCase --private-type-case camelCase --doc-text-before-function-name '' --doc-newline-before-package-declaration --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --package-name edwards25519 Scalar 64 '2^252 + 27742317777372353535851937790883648493' mul add sub opp nonzero from_montgolangmery to_montgolangmery to_bytes from_bytes
//
// curve description: Scalar
//
// machine_wordsize = 64 (from "64")
//
// requested operations: mul, add, sub, opp, nonzero, from_montgolangmery, to_montgolangmery, to_bytes, from_bytes
//
...
//
//   functions synthesized for this Montgolangmery arithmetic require the
//
...
// The type fiatScalarMontgolangmeryDomainFieldElement is a field element in the Montgolangmery domain.
//
// Bounds: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
type fiatScalarMontgolangmeryDomainFieldElement [4]uint64

// The type fiatScalarNonMontgolangmeryDomainFieldElement is a field element NOT in the Montgolangmery domain.
//
// Bounds: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
type fiatScalarNonMontgolangmeryDomainFieldElement [4]uint64
...
// fiatScalarMul multiplies two field elements in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
// Postconditions:
//
//	eval (from_montgolangmery out1) mod m = (eval (from_montgolangmery arg1) * eval (from_montgolangmery arg2)) mod m
//	0 ≤ eval out1 < m
func fiatScalarMul(out1 *fiatScalarMontgolangmeryDomainFieldElement, arg1 *fiatScalarMontgolangmeryDomainFieldElement, arg2 *fiatScalarMontgolangmeryDomainFieldElement) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
	x4 := arg1[0]
...
// fiatScalarAdd adds two field elements in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	eval (from_montgolangmery out1) mod m = (eval (from_montgolangmery arg1) + eval (from_montgolangmery arg2)) mod m
//	0 ≤ eval out1 < m
func fiatScalarAdd(out1 *fiatScalarMontgolangmeryDomainFieldElement, arg1 *fiatScalarMontgolangmeryDomainFieldElement, arg2 *fiatScalarMontgolangmeryDomainFieldElement) {
	var x1 uint64
	var x2 uint64
...
// fiatScalarSub subtracts two field elements in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	eval (from_montgolangmery out1) mod m = (eval (from_montgolangmery arg1) - eval (from_montgolangmery arg2)) mod m
//	0 ≤ eval out1 < m
func fiatScalarSub(out1 *fiatScalarMontgolangmeryDomainFieldElement, arg1 *fiatScalarMontgolangmeryDomainFieldElement, arg2 *fiatScalarMontgolangmeryDomainFieldElement) {
	var x1 uint64
	var x2 uint64
...
// fiatScalarOpp negates a field element in the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
// Postconditions:
//
//	eval (from_montgolangmery out1) mod m = -eval (from_montgolangmery arg1) mod m
//	0 ≤ eval out1 < m
func fiatScalarOpp(out1 *fiatScalarMontgolangmeryDomainFieldElement, arg1 *fiatScalarMontgolangmeryDomainFieldElement) {
	var x1 uint64
	var x2 uint64
...
// Postconditions:
//
//	out1 = 0 ↔ eval (from_montgolangmery arg1) mod m = 0
//
// Input Bounds:
//
...
// fiatScalarFromMontgolangmery translates a field element out of the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
//	0 ≤ eval out1 < m
func fiatScalarFromMontgolangmery(out1 *fiatScalarNonMontgolangmeryDomainFieldElement, arg1 *fiatScalarMontgolangmeryDomainFieldElement) {
	x1 := arg1[0]
	var x2 uint64
...
// fiatScalarToMontgolangmery translates a field element into the Montgolangmery domain.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
// Postconditions:
//
//	eval (from_montgolangmery out1) mod m = eval arg1 mod m
//	0 ≤ eval out1 < m
func fiatScalarToMontgolangmery(out1 *fiatScalarMontgolangmeryDomainFieldElement, arg1 *fiatScalarNonMontgolangmeryDomainFieldElement) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
	x4 := arg1[0]
...
// fiatScalarToBytes serializes a field element NOT in the Montgolangmery domain to bytes in little-endian order.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m
...
// fiatScalarFromBytes deserializes a field element NOT in the Montgolangmery domain from bytes in little-endian order.
//
// Preconditions:
//
//	0 ≤ bytes_eval arg1 < m
