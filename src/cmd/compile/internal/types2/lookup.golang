...
func lookupFieldOrMethod(T Type, addressable bool, pkg *Package, name string, foldCase bool) (obj Object, index []int, indirect bool) {
	...
	// not have found it for T (see also golang.dev/issue/8590).
	...
	const enableTParamFieldLookup = false // see golang.dev/issue/51576
	...
	if cause != nil {
		...
		case wrongSig:
			...
			if fs == ms {
				...
				// Add package information to disambiguate (golang.dev/issue/54258).
