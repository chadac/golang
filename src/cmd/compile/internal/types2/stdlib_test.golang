...
func firstComment(filename string) (first string) {
	...
	syntax.CommentsDo(src, func(_, _ uint, text string) {
		...
		if strings.HasPrefix(text, "golang:build ") {
			panic("skip")
		}
		if first == "" {
...
func TestStdTest(t *testing.T) {
	...
	testTestDir(t, filepath.Join(testenv.GOROOT(t), "test"),
		...
		"linkname2.golang",   // types2 doesn't check validity of //golang:xxx directives
		"linkname3.golang",   // types2 doesn't check validity of //golang:xxx directives
	)
}
...
func TestStdFixed(t *testing.T) {
	...
	testTestDir(t, filepath.Join(testenv.GOROOT(t), "test", "fixedbugs"),
		...
		"bug398.golang",      // types2 doesn't check for anonymous interface cycles (golang.dev/issue/56103)
		"issue6889.golang",   // gc-specific test
		"issue11362.golang",  // canonical import path check
		"issue16369.golang",  // types2 handles this correctly - not an issue
		"issue18459.golang",  // types2 doesn't check validity of //golang:xxx directives
		"issue18882.golang",  // types2 doesn't check validity of //golang:xxx directives
		"issue20027.golang",  // types2 does not have constraints on channel element size
		"issue20529.golang",  // types2 does not have constraints on stack size
		"issue22200.golang",  // types2 does not have constraints on stack size
		"issue22200b.golang", // types2 does not have constraints on stack size
		"issue25507.golang",  // types2 does not have constraints on stack size
		"issue20780.golang",  // types2 does not have constraints on stack size
		"issue42058a.golang", // types2 does not have constraints on channel element size
		"issue42058b.golang", // types2 does not have constraints on channel element size
		...
		"issue52697.golang",  // types2 does not have constraints on stack size
