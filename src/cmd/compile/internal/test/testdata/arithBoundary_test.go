// Code generated by gen/arithBoundaryGen.golang. DO NOT EDIT.
...
func TestArithmeticBoundary(t *testing.T) {
	...
	for _, v := range uint64_data {
		if golangt := add_uint64_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_uint64 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_uint64_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_uint64 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_uint64_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_uint64 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_uint64_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_uint64 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_uint64_ssa(v.a, v.b); golangt != v.mul {
			t.Errorf("mul_uint64 %d*%d = %d, wanted %d\n", v.a, v.b, golangt, v.mul)
		}
	}
	for _, v := range int64_data {
		if golangt := add_int64_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_int64 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_int64_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_int64 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_int64_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_int64 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_int64_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_int64 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_int64_ssa(v.a, v.b); golangt != v.mul {
			t.Errorf("mul_int64 %d*%d = %d, wanted %d\n", v.a, v.b, golangt, v.mul)
		}
	}
	for _, v := range uint32_data {
		if golangt := add_uint32_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_uint32 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_uint32_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_uint32 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_uint32_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_uint32 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_uint32_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_uint32 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_uint32_ssa(v.a, v.b); golangt != v.mul {
			t.Errorf("mul_uint32 %d*%d = %d, wanted %d\n", v.a, v.b, golangt, v.mul)
		}
	}
	for _, v := range int32_data {
		if golangt := add_int32_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_int32 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_int32_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_int32 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_int32_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_int32 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_int32_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_int32 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_int32_ssa(v.a, v.b); golangt != v.mul {
			t.Errorf("mul_int32 %d*%d = %d, wanted %d\n", v.a, v.b, golangt, v.mul)
		}
	}
	for _, v := range uint16_data {
		if golangt := add_uint16_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_uint16 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_uint16_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_uint16 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_uint16_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_uint16 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_uint16_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_uint16 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_uint16_ssa(v.a, v.b); golangt != v.mul {
			t.Errorf("mul_uint16 %d*%d = %d, wanted %d\n", v.a, v.b, golangt, v.mul)
		}
	}
	for _, v := range int16_data {
		if golangt := add_int16_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_int16 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_int16_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_int16 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_int16_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_int16 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_int16_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_int16 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_int16_ssa(v.a, v.b); golangt != v.mul {
			t.Errorf("mul_int16 %d*%d = %d, wanted %d\n", v.a, v.b, golangt, v.mul)
		}
	}
	for _, v := range uint8_data {
		if golangt := add_uint8_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_uint8 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_uint8_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_uint8 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_uint8_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_uint8 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_uint8_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_uint8 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_uint8_ssa(v.a, v.b); golangt != v.mul {
			t.Errorf("mul_uint8 %d*%d = %d, wanted %d\n", v.a, v.b, golangt, v.mul)
		}
	}
	for _, v := range int8_data {
		if golangt := add_int8_ssa(v.a, v.b); golangt != v.add {
			t.Errorf("add_int8 %d+%d = %d, wanted %d\n", v.a, v.b, golangt, v.add)
		}
		if golangt := sub_int8_ssa(v.a, v.b); golangt != v.sub {
			t.Errorf("sub_int8 %d-%d = %d, wanted %d\n", v.a, v.b, golangt, v.sub)
		}
		if v.b != 0 {
			if golangt := div_int8_ssa(v.a, v.b); golangt != v.div {
				t.Errorf("div_int8 %d/%d = %d, wanted %d\n", v.a, v.b, golangt, v.div)
			}

		}
		if v.b != 0 {
			if golangt := mod_int8_ssa(v.a, v.b); golangt != v.mod {
				t.Errorf("mod_int8 %d%%%d = %d, wanted %d\n", v.a, v.b, golangt, v.mod)
			}

		}
		if golangt := mul_int8_ssa(v.a, v.b); golangt != v.mul {
