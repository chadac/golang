...
// launch with `golang run constFoldGen.golang` a file called constFold_test.golang
...
func main() {
	w := new(bytes.Buffer)
	fmt.Fprintf(w, "// run\n")
	fmt.Fprintf(w, "// Code generated by gen/constFoldGen.golang. DO NOT EDIT.\n\n")
	...
	// write to file
	err = os.WriteFile("../../constFold_test.golang", src, 0666)
	if err != nil {
