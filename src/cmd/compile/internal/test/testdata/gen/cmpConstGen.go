...
// launch with `golang run cmpConstGen.golang` a file called cmpConst.golang
...
func main() {
	...
	w := new(bytes.Buffer)
	fmt.Fprintf(w, "// Code generated by gen/cmpConstGen.golang. DO NOT EDIT.\n\n")
	...
	for _, typ := range types {
		...
		for _, r := range values {
			...
			for _, op := range operators {
				// no need for golang:noinline because the function is called indirectly
	...
	// write to file
	err = os.WriteFile("../cmpConst_test.golang", src, 0666)
	if err != nil {
