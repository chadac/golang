...
const pvagenfile = "./putvarabbrevgen.golang"
...
// TestPutVarAbbrevGenerator checks that putvarabbrevgen.golang is kept in sync
...
func pvagenerate(t *testing.T) string {
	...
	f, err := parser.ParseFile(&fset, "./dwarf.golang", nil, parser.ParseComments)
	if err != nil {
		t.Fatal(err)
	}
...
// Regenerate using golang test -run TestPutVarAbbrevGenerator -generate instead.
