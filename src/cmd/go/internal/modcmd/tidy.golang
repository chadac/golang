...
'golang' command from the indicated major Go release to successfully load
...
var (
	...
	tidyGo     golangVersionFlag // golang version to write to the tidied golang.mod file (toggles lazy loading)
...
func init() {
	...
	cmdTidy.Flag.Var(&tidyGo, "golang", "")
	cmdTidy.Flag.Var(&tidyCompat, "compat", "")
	base.AddChdirFlag(&cmdTidy.Flag)
	base.AddModCommonFlags(&cmdTidy.Flag)
}

// A golangVersionFlag is a flag.Value representing a supported Go version.
//
