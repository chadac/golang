...
func init() {
	...
	cmdEdit.Flag.Var(flagFunc(flagGodebug), "golangdebug", "")
	cmdEdit.Flag.Var(flagFunc(flagDropGodebug), "dropgolangdebug", "")
...
// flagGodebug implements the -golangdebug flag.
...
// flagDropGodebug implements the -dropgolangdebug flag.
