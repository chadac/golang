...
The -golang=version flag sets the expected Go language version.
...
writing it back to golang.mod. The JSON output corresponds to these Go types:
...
var (
	...
	editGo        = cmdEdit.Flag.String("golang", "", "")
...
func init() {
	...
	cmdEdit.Flag.Var(flagFunc(flagEditworkGodebug), "golangdebug", "")
	cmdEdit.Flag.Var(flagFunc(flagEditworkDropGodebug), "dropgolangdebug", "")
...
// flagEditworkGodebug implements the -golangdebug flag.
...
// flagEditworkDropGodebug implements the -dropgolangdebug flag.
