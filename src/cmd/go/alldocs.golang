...
// Code generated by 'golang test cmd/golang -v -run=^TestDocsUpToDate$ -fixdocs'; DO NOT EDIT.
// Edit the documentation in other files and then execute 'golang generate cmd/golang' to generate this one.

// Go is a tool for managing Go source code.
//
// Usage:
//
//	golang <command> [arguments]
//
// The commands are:
//
...
//	fmt         golangfmt (reformat) package sources
...
//	test        test packages
//	tool        run specified golang tool
//	version     print Go version
//	vet         report likely mistakes in packages
//
// Use "golang help <command>" for more information about a command.
//
...
//	filetype        file types
//	golangauth          GOAUTH environment variable
//	golang.mod          the golang.mod file
//	golangpath          GOPATH environment variable
//	golangproxy         module proxy protocol
//	importpath      import path syntax
//	modules         modules, module versions, and more
//	module-auth     module authentication using golang.sum
...
//
// Use "golang help <topic>" for more information about that topic.
//
// # Start a bug report
//
// Usage:
...
// Usage:
//
//	golang build [-o output] [build flags] [packages]
//
...
// Usage:
//
//	golang clean [-i] [-r] [-cache] [-testcache] [-modcache] [-fuzzcache] [build flags] [packages]
//
...
// Usage:
//
//	golang doc [doc flags] [package|[package.]symbol[.methodOrField]]
//
...
// Usage:
//
//	golang env [-json] [-changed] [-u] [-w] [var ...]
//
...
// Usage:
//
//	golang generate [-run regexp] [-n] [-v] [-x] [build flags] [file.golang... | packages]
//
...
// Usage:
//
//	golang get [-t] [-u] [-tool] [build flags] [packages]
//
...
// Usage:
//
//	golang install [build flags] [packages]
//
...
// Usage:
//
//	golang list [-f format] [-json] [-m] [list flags] [build flags] [packages]
//
...
// Usage:
//
//	golang mod <command> [arguments]
//
// The commands are:
//
//	download    download modules to local cache
//	edit        edit golang.mod from tools or scripts
...
//
// Use "golang help mod <command>" for more information about a command.
//
// # Download modules to local cache
//
// Usage:
//
//	golang mod download [-x] [-json] [-reuse=old.json] [modules]
//
...
//
// # Edit golang.mod from tools or scripts
//
// Usage:
//
//	golang mod edit [editing flags] [-fmt|-print|-json] [golang.mod]
//
...
// Usage:
//
//	golang mod graph [-golang=version] [-x]
//
...
// Usage:
//
//	golang mod tidy [-e] [-v] [-x] [-diff] [-golang=version] [-compat=version]
//
...
// Usage:
//
//	golang mod vendor [-e] [-v] [-o outdir]
//
...
// Usage:
//
//	golang mod why [-m] [-vendor] packages...
//
...
// Usage:
//
//	golang work <command> [arguments]
//
// The commands are:
//
//	edit        edit golang.work from tools or scripts
//	init        initialize workspace file
//	sync        sync workspace build list to modules
//	use         add modules to workspace file
//	vendor      make vendored copy of dependencies
//
// Use "golang help work <command>" for more information about a command.
//
// # Edit golang.work from tools or scripts
//
// Usage:
//
//	golang work edit [editing flags] [golang.work]
//
// Edit provides a command-line interface for editing golang.work,
...
// Usage:
//
//	golang work init [moddirs]
//
// Init initializes and writes a new golang.work file in the
...
// Usage:
//
//	golang work vendor [-e] [-v] [-o outdir]
//
...
// Usage:
//
//	golang run [build flags] [-exec xprog] package [arguments...]
//
...
// Usage:
//
//	golang test [build/test flags] [packages] [build/test flags & test binary flags]
//
...
//
// # Run specified golang tool
//
// Usage:
//
//	golang tool [-n] command [args...]
//
...
// Usage:
//
//	golang vet [build flags] [-vettool prog] [vet flags] [packages]
//
...
//
// # Module authentication using golang.sum
//
