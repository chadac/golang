...
func PseudoVersionBase(v string) (string, error) {
	...
	case "":
		...
		if build != "" {
			...
			//
			// There are a few such entries in the index generated by proxy.golanglang.org,
	...
	case "-0":
		...
		if patch == "" {
			...
			// generated by requests to proxy.golanglang.org.
			//
			...
			// actual golang.mod files. If we find actual examples of this form and a
