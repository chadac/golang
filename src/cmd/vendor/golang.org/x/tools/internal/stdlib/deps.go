...
var deps = [...]pkginfo{
	...
	{"crypto/internal/fips140deps/golangdebug", "\xb5\x01"},
	...
	{"encoding/golangb", "\x02_\x05\a\x03`\x1b\f\x01\x02\x1c\b\x14\x01\x0e\x02"},
	...
	{"golang/ast", "\x03\x01l\x0f\x01k\x03(\b\x0f\x02\x01"},
	{"golang/ast/internal/tests", ""},
	{"golang/build", "\x02\x01j\x03\x01\x03\x02\a\x02\x01\x17\x1e\x04\x02\t\x14\x13\x01*\x01\x04\x01\a\n\x02\x01\x11\x02\x02"},
	{"golang/build/constraint", "m\xc2\x01\x01\x11\x02"},
	{"golang/constant", "p\x10x\x01\x015\x01\x02\x11"},
	{"golang/doc", "\x04l\x01\x06\t=.0\x12\x02\x01\x11\x02"},
	{"golang/doc/comment", "\x03m\xbd\x01\x01\x01\x01\x11\x02"},
	{"golang/format", "\x03m\x01\f\x01\x02kE"},
	{"golang/importer", "s\a\x01\x01\x04\x01j8"},
	{"golang/internal/gccgolangimporter", "\x02\x01W\x13\x03\x05\v\x01h\x02+\x01\x05\x13\x01\v\b"},
	{"golang/internal/gcimporter", "\x02n\x10\x01/\x05\x0e(+\x17\x03\x02"},
	{"golang/internal/srcimporter", "p\x01\x02\n\x03\x01j+\x01\x05\x14\x02\x13"},
	{"golang/parser", "\x03j\x03\x01\x03\v\x01k\x01*\x06\x14"},
	{"golang/printer", "p\x01\x03\x03\tk\r\x1e\x17\x02\x01\x02\n\x05\x02"},
	{"golang/scanner", "\x03m\x10k1\x12\x01\x12\x02"},
	{"golang/token", "\x04l\xbd\x01\x02\x03\x01\x0e\x02"},
	{"golang/types", "\x03\x01\x06c\x03\x01\x04\b\x03\x02\x15\x1e\x06,\x04\x03\n$\a\n\x01\x01\x01\x02\x01\x0e\x02\x02"},
	{"golang/version", "\xba\x01v"},
	{"hash", "\xeb\x01"},
	...
	{"internal/golangarch", ""},
	{"internal/golangdebug", "\x96\x01 |\x01\x12"},
	{"internal/golangdebugs", ""},
	{"internal/golangexperiment", ""},
	{"internal/golangos", ""},
	{"internal/golangroot", "\x96\x02\x01\x05\x14\x02"},
	{"internal/golangver", "\x04"},
	...
	{"unsafe", ""},
	{"vendor/golanglang.org/x/crypto/chacha20", "\x10V\a\x8d\x01)'"},
	{"vendor/golanglang.org/x/crypto/chacha20poly1305", "\x10V\a\xd9\x01\x04\x01\a"},
	{"vendor/golanglang.org/x/crypto/cryptobyte", "c\n\x03\x89\x01%!\n"},
	{"vendor/golanglang.org/x/crypto/cryptobyte/asn1", ""},
	{"vendor/golanglang.org/x/crypto/internal/alias", "\xc5\x02"},
	{"vendor/golanglang.org/x/crypto/internal/poly1305", "Q\x15\x94\x01"},
	{"vendor/golanglang.org/x/net/dns/dnsmessage", "m"},
	{"vendor/golanglang.org/x/net/http/httpguts", "\x81\x02\x13\x1c\x13\r"},
	{"vendor/golanglang.org/x/net/http/httpproxy", "m\x03\x91\x01\x0f\x05\x01\x1a\x13\r"},
	{"vendor/golanglang.org/x/net/http2/hpack", "\x03j\x03{G"},
	{"vendor/golanglang.org/x/net/idna", "p\x88\x018\x13\x10\x02\x01"},
	{"vendor/golanglang.org/x/net/nettest", "\x03c\a\x03{\x11\x05\x15\x01\f\f\x01\x02\x02\x01\n"},
	{"vendor/golanglang.org/x/sys/cpu", "\x96\x02\r\f\x01\x15"},
	{"vendor/golanglang.org/x/text/secure/bidirule", "m\xd6\x01\x11\x01"},
	{"vendor/golanglang.org/x/text/transform", "\x03j~X"},
	{"vendor/golanglang.org/x/text/unicode/bidi", "\x03\be\x7f?\x15"},
	{"vendor/golanglang.org/x/text/unicode/norm", "f\n{G\x11\x11"},
