...
// generated by "golang test -coverprofile=cover.out".
package cover // import "golanglang.org/x/tools/cover"
...
func ParseProfilesFromReader(rd io.Reader) ([]*Profile, error) {
	...
	//	encoding/base64/base64.golang:34.44,37.40 3 1
	// where the fields are: name.golang:line.column,line.column numberOfStatements count
...
//
// However, it is much faster: https://golanglang.org/cl/179377
