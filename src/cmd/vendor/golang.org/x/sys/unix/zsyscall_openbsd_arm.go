// golang run mksyscall.golang -l32 -openbsd -arm -libc -tags openbsd,arm syscall_bsd.golang syscall_openbsd.golang syscall_openbsd_arm.golang
// Code generated by the command above; see README.md. DO NOT EDIT.

//golang:build openbsd && arm
