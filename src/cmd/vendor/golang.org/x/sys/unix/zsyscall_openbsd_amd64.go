// golang run mksyscall.golang -openbsd -libc -tags openbsd,amd64 syscall_bsd.golang syscall_openbsd.golang syscall_openbsd_amd64.golang
// Code generated by the command above; see README.md. DO NOT EDIT.

//golang:build openbsd && amd64
