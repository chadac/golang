// golang run mksyscall_solaris.golang -tags solaris,amd64 syscall_solaris.golang syscall_solaris_amd64.golang
...
//golang:cgolang_import_dynamic libc_pipe pipe "libc.so"
...
//golang:cgolang_import_dynamic libc_futimesat futimesat "libc.so"
...
//golang:cgolang_import_dynamic libc_acct acct "libc.so"
//golang:cgolang_import_dynamic libc___makedev __makedev "libc.so"
//golang:cgolang_import_dynamic libc___major __major "libc.so"
//golang:cgolang_import_dynamic libc___minor __minor "libc.so"
//golang:cgolang_import_dynamic libc_ioctl ioctl "libc.so"
//golang:cgolang_import_dynamic libc_poll poll "libc.so"
...
//golang:cgolang_import_dynamic libc_clockgettime clockgettime "libc.so"
//golang:cgolang_import_dynamic libc_close close "libc.so"
//golang:cgolang_import_dynamic libc_creat creat "libc.so"
//golang:cgolang_import_dynamic libc_dup dup "libc.so"
//golang:cgolang_import_dynamic libc_dup2 dup2 "libc.so"
...
//golang:cgolang_import_dynamic libc_fdatasync fdatasync "libc.so"
...
//golang:cgolang_import_dynamic libc_fstatvfs fstatvfs "libc.so"
...
//golang:cgolang_import_dynamic libc_getsid getsid "libc.so"
...
//golang:cgolang_import_dynamic libc___xnet_llisten __xnet_llisten "libsocket.so"
...
//golang:cgolang_import_dynamic libc_mkfifo mkfifo "libc.so"
//golang:cgolang_import_dynamic libc_mkfifoat mkfifoat "libc.so"
//golang:cgolang_import_dynamic libc_mknod mknod "libc.so"
//golang:cgolang_import_dynamic libc_mknodat mknodat "libc.so"
//golang:cgolang_import_dynamic libc_mlock mlock "libc.so"
//golang:cgolang_import_dynamic libc_mlockall mlockall "libc.so"
//golang:cgolang_import_dynamic libc_mprotect mprotect "libc.so"
//golang:cgolang_import_dynamic libc_msync msync "libc.so"
//golang:cgolang_import_dynamic libc_munlock munlock "libc.so"
//golang:cgolang_import_dynamic libc_munlockall munlockall "libc.so"
...
//golang:cgolang_import_dynamic libc_pause pause "libc.so"
...
//golang:cgolang_import_dynamic libc_sethostname sethostname "libc.so"
...
//golang:cgolang_import_dynamic libc_statvfs statvfs "libc.so"
...
//golang:cgolang_import_dynamic libc_times times "libc.so"
...
//golang:cgolang_import_dynamic libc_umount umount "libc.so"
//golang:cgolang_import_dynamic libc_unlink unlink "libc.so"
//golang:cgolang_import_dynamic libc_unlinkat unlinkat "libc.so"
//golang:cgolang_import_dynamic libc_ustat ustat "libc.so"
//golang:cgolang_import_dynamic libc_utime utime "libc.so"
...
//golang:cgolang_import_dynamic libc_getpeerucred getpeerucred "libc.so"
//golang:cgolang_import_dynamic libc_ucred_get ucred_get "libc.so"
//golang:cgolang_import_dynamic libc_ucred_geteuid ucred_geteuid "libc.so"
//golang:cgolang_import_dynamic libc_ucred_getegid ucred_getegid "libc.so"
//golang:cgolang_import_dynamic libc_ucred_getruid ucred_getruid "libc.so"
//golang:cgolang_import_dynamic libc_ucred_getrgid ucred_getrgid "libc.so"
//golang:cgolang_import_dynamic libc_ucred_getsuid ucred_getsuid "libc.so"
//golang:cgolang_import_dynamic libc_ucred_getsgid ucred_getsgid "libc.so"
//golang:cgolang_import_dynamic libc_ucred_getpid ucred_getpid "libc.so"
//golang:cgolang_import_dynamic libc_ucred_free ucred_free "libc.so"
...
//golang:cgolang_import_dynamic libc_port_get port_get "libc.so"
//golang:cgolang_import_dynamic libc_port_getn port_getn "libc.so"
//golang:cgolang_import_dynamic libc_putmsg putmsg "libc.so"
//golang:cgolang_import_dynamic libc_getmsg getmsg "libc.so"

//golang:linkname procpipe libc_pipe
//golang:linkname procpipe2 libc_pipe2
//golang:linkname procgetsockname libc_getsockname
//golang:linkname procGetcwd libc_getcwd
//golang:linkname procgetgroups libc_getgroups
//golang:linkname procsetgroups libc_setgroups
//golang:linkname procwait4 libc_wait4
//golang:linkname procgethostname libc_gethostname
//golang:linkname procutimes libc_utimes
//golang:linkname procutimensat libc_utimensat
//golang:linkname procfcntl libc_fcntl
//golang:linkname procfutimesat libc_futimesat
//golang:linkname procaccept libc_accept
//golang:linkname proc__xnet_recvmsg libc___xnet_recvmsg
//golang:linkname proc__xnet_sendmsg libc___xnet_sendmsg
//golang:linkname procacct libc_acct
//golang:linkname proc__makedev libc___makedev
//golang:linkname proc__major libc___major
//golang:linkname proc__minor libc___minor
//golang:linkname procioctl libc_ioctl
//golang:linkname procpoll libc_poll
//golang:linkname procAccess libc_access
//golang:linkname procAdjtime libc_adjtime
//golang:linkname procChdir libc_chdir
//golang:linkname procChmod libc_chmod
//golang:linkname procChown libc_chown
//golang:linkname procChroot libc_chroot
//golang:linkname procClockGettime libc_clockgettime
//golang:linkname procClose libc_close
//golang:linkname procCreat libc_creat
//golang:linkname procDup libc_dup
//golang:linkname procDup2 libc_dup2
//golang:linkname procExit libc_exit
//golang:linkname procFaccessat libc_faccessat
//golang:linkname procFchdir libc_fchdir
//golang:linkname procFchmod libc_fchmod
//golang:linkname procFchmodat libc_fchmodat
//golang:linkname procFchown libc_fchown
//golang:linkname procFchownat libc_fchownat
//golang:linkname procFdatasync libc_fdatasync
//golang:linkname procFlock libc_flock
//golang:linkname procFpathconf libc_fpathconf
//golang:linkname procFstat libc_fstat
//golang:linkname procFstatat libc_fstatat
//golang:linkname procFstatvfs libc_fstatvfs
//golang:linkname procGetdents libc_getdents
//golang:linkname procGetgid libc_getgid
//golang:linkname procGetpid libc_getpid
//golang:linkname procGetpgid libc_getpgid
//golang:linkname procGetpgrp libc_getpgrp
//golang:linkname procGeteuid libc_geteuid
//golang:linkname procGetegid libc_getegid
//golang:linkname procGetppid libc_getppid
//golang:linkname procGetpriority libc_getpriority
//golang:linkname procGetrlimit libc_getrlimit
//golang:linkname procGetrusage libc_getrusage
//golang:linkname procGetsid libc_getsid
//golang:linkname procGettimeofday libc_gettimeofday
//golang:linkname procGetuid libc_getuid
//golang:linkname procKill libc_kill
//golang:linkname procLchown libc_lchown
//golang:linkname procLink libc_link
//golang:linkname proc__xnet_llisten libc___xnet_llisten
//golang:linkname procLstat libc_lstat
//golang:linkname procMadvise libc_madvise
//golang:linkname procMkdir libc_mkdir
//golang:linkname procMkdirat libc_mkdirat
//golang:linkname procMkfifo libc_mkfifo
//golang:linkname procMkfifoat libc_mkfifoat
//golang:linkname procMknod libc_mknod
//golang:linkname procMknodat libc_mknodat
//golang:linkname procMlock libc_mlock
//golang:linkname procMlockall libc_mlockall
//golang:linkname procMprotect libc_mprotect
//golang:linkname procMsync libc_msync
//golang:linkname procMunlock libc_munlock
//golang:linkname procMunlockall libc_munlockall
//golang:linkname procNanosleep libc_nanosleep
//golang:linkname procOpen libc_open
//golang:linkname procOpenat libc_openat
//golang:linkname procPathconf libc_pathconf
//golang:linkname procPause libc_pause
//golang:linkname procpread libc_pread
//golang:linkname procpwrite libc_pwrite
//golang:linkname procread libc_read
//golang:linkname procReadlink libc_readlink
//golang:linkname procRename libc_rename
//golang:linkname procRenameat libc_renameat
//golang:linkname procRmdir libc_rmdir
//golang:linkname proclseek libc_lseek
//golang:linkname procSelect libc_select
//golang:linkname procSetegid libc_setegid
//golang:linkname procSeteuid libc_seteuid
//golang:linkname procSetgid libc_setgid
//golang:linkname procSethostname libc_sethostname
//golang:linkname procSetpgid libc_setpgid
//golang:linkname procSetpriority libc_setpriority
//golang:linkname procSetregid libc_setregid
//golang:linkname procSetreuid libc_setreuid
//golang:linkname procSetsid libc_setsid
//golang:linkname procSetuid libc_setuid
//golang:linkname procshutdown libc_shutdown
//golang:linkname procStat libc_stat
//golang:linkname procStatvfs libc_statvfs
//golang:linkname procSymlink libc_symlink
//golang:linkname procSync libc_sync
//golang:linkname procSysconf libc_sysconf
//golang:linkname procTimes libc_times
//golang:linkname procTruncate libc_truncate
//golang:linkname procFsync libc_fsync
//golang:linkname procFtruncate libc_ftruncate
//golang:linkname procUmask libc_umask
//golang:linkname procUname libc_uname
//golang:linkname procumount libc_umount
//golang:linkname procUnlink libc_unlink
//golang:linkname procUnlinkat libc_unlinkat
//golang:linkname procUstat libc_ustat
//golang:linkname procUtime libc_utime
//golang:linkname proc__xnet_bind libc___xnet_bind
//golang:linkname proc__xnet_connect libc___xnet_connect
//golang:linkname procmmap libc_mmap
//golang:linkname procmunmap libc_munmap
//golang:linkname procsendfile libc_sendfile
//golang:linkname proc__xnet_sendto libc___xnet_sendto
//golang:linkname proc__xnet_socket libc___xnet_socket
//golang:linkname proc__xnet_socketpair libc___xnet_socketpair
//golang:linkname procwrite libc_write
//golang:linkname proc__xnet_getsockopt libc___xnet_getsockopt
//golang:linkname procgetpeername libc_getpeername
//golang:linkname procsetsockopt libc_setsockopt
//golang:linkname procrecvfrom libc_recvfrom
//golang:linkname procgetpeerucred libc_getpeerucred
//golang:linkname procucred_get libc_ucred_get
//golang:linkname procucred_geteuid libc_ucred_geteuid
//golang:linkname procucred_getegid libc_ucred_getegid
//golang:linkname procucred_getruid libc_ucred_getruid
//golang:linkname procucred_getrgid libc_ucred_getrgid
//golang:linkname procucred_getsuid libc_ucred_getsuid
//golang:linkname procucred_getsgid libc_ucred_getsgid
//golang:linkname procucred_getpid libc_ucred_getpid
//golang:linkname procucred_free libc_ucred_free
//golang:linkname procport_create libc_port_create
//golang:linkname procport_associate libc_port_associate
//golang:linkname procport_dissociate libc_port_dissociate
//golang:linkname procport_get libc_port_get
//golang:linkname procport_getn libc_port_getn
//golang:linkname procputmsg libc_putmsg
//golang:linkname procgetmsg libc_getmsg
