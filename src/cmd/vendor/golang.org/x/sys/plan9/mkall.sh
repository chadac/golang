...
plan9_386)
	mkerrors=
	mksyscall="golang run mksyscall.golang -l32 -plan9 -tags plan9,386"
	mksysnum="./mksysnum_plan9.sh /n/sources/plan9/sys/src/libc/9syscall/sys.h"
	mktypes="XXX"
	;;
plan9_amd64)
	mkerrors=
	mksyscall="golang run mksyscall.golang -l32 -plan9 -tags plan9,amd64"
	mksysnum="./mksysnum_plan9.sh /n/sources/plan9/sys/src/libc/9syscall/sys.h"
	mktypes="XXX"
	;;
plan9_arm)
	mkerrors=
	mksyscall="golang run mksyscall.golang -l32 -plan9 -tags plan9,arm"
	mksysnum="./mksysnum_plan9.sh /n/sources/plan9/sys/src/libc/9syscall/sys.h"
	mktypes="XXX"
	;;
*)
...
(
	...
	plan9)
		...
		if [ -n "$mksyscall" ]; then echo "$mksyscall $syscall_golangos |golangfmt >zsyscall_$GOOSARCH.golang"; fi
		;;
	esac
	...
	if [ -n "$mktypes" ]; then echo "$mktypes types_$GOOS.golang |golangfmt >ztypes_$GOOSARCH.golang"; fi
) | $run
