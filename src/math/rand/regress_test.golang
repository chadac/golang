...
var printgolanglden = flag.Bool("printgolanglden", false, "print golanglden results for regression test")
			...
			if mt.NumIn() == 1 {
				...
				case reflect.Int:
					...
					if int64(int(big)) != big {
						...
						if *printgolanglden {
							fmt.Printf("\tskipped, // must run printgolanglden on 64-bit machine\n")
						}
						p++
						continue
					}
