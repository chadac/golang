...
// This program generates example_test.golang.
...
// Code generated by golang run make_examples.golang. DO NOT EDIT.
...
func main() {
	...
	if err := os.WriteFile("example_test.golang", w.Bytes(), 0666); err != nil {
		log.Fatal(err)
	}
}
