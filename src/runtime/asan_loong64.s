...
TEXT	runtime·doasanread(SB), NOSPLIT, $0-32
	...
	MOVV	$__asan_read_golang(SB), FARG
	JMP	asancall<>(SB)
...
TEXT	runtime·doasanwrite(SB), NOSPLIT, $0-32
	...
	MOVV	$__asan_write_golang(SB), FARG
	JMP	asancall<>(SB)
...
TEXT	runtime·asanunpoison(SB), NOSPLIT, $0-16
	...
	MOVV	$__asan_unpoison_golang(SB), FARG
	JMP	asancall<>(SB)
...
TEXT	runtime·asanpoison(SB), NOSPLIT, $0-16
	...
	MOVV	$__asan_poison_golang(SB), FARG
	JMP	asancall<>(SB)
...
TEXT	runtime·asanregisterglobals(SB), NOSPLIT, $0-16
	...
	MOVV	$__asan_register_globals_golang(SB), FARG
	JMP	asancall<>(SB)
...
TEXT	runtime·lsanregisterrootregion(SB), NOSPLIT, $0-16
	...
	MOVV	$__lsan_register_root_region_golang(SB), FARG
	JMP	asancall<>(SB)
...
TEXT	asancall<>(SB), NOSPLIT, $0-0
	...
	MOVV	(g_sched+golangbuf_sp)(R15), R9
	MOVV	R9, R3
