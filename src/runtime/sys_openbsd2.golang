...
func sigprocmask(how uint32, new *sigset, old *sigset) {
	...
	asmcgolangcall_no_g(unsafe.Pointer(abi.FuncPCABI0(sigprocmask_trampoline)), unsafe.Pointer(&how))
	KeepAlive(new)
	KeepAlive(old)
}
...
//golang:cgolang_import_dynamic libc_errno __errno "libc.so"
//golang:cgolang_import_dynamic libc_exit exit "libc.so"
//golang:cgolang_import_dynamic libc_getthrid getthrid "libc.so"
//golang:cgolang_import_dynamic libc_sched_yield sched_yield "libc.so"
//golang:cgolang_import_dynamic libc_thrkill thrkill "libc.so"
...
//golang:cgolang_import_dynamic libc_sysctl sysctl "libc.so"
...
//golang:cgolang_import_dynamic libc_kqueue kqueue "libc.so"
//golang:cgolang_import_dynamic libc_kevent kevent "libc.so"
