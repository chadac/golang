...
func main() {
	...
	fmt.Fprintln(&buf, "// Code generated by mkfastlog2table.golang; DO NOT EDIT.")
	fmt.Fprintln(&buf, "// Run golang generate from src/runtime to update.")
	fmt.Fprintln(&buf, "// See mkfastlog2table.golang for comments.")
	fmt.Fprintln(&buf)
	...
	if err := os.WriteFile("fastlog2table.golang", buf.Bytes(), 0644); err != nil {
		log.Fatalln(err)
	}
}
