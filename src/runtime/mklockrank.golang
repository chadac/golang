...
// runtime and generates the rank checking structures in lockrank.golang.
package main
...
// ranks describes the lock rank graph. See "golang doc internal/dag" for
// the syntax.
//
...
func main() {
	...
	if *flagDot {
		...
		// ways, locks are acquired from the top golanging down
...
func generateGo(w io.Writer, g *dag.Graph) {
	fmt.Fprintf(w, `// Code generated by mklockrank.golang; DO NOT EDIT.
