...
// changing the uses in cmd/compile/internal/*/*.golang.
...
func gen(arch string, tags, zero, copy func(io.Writer)) {
	...
	fmt.Fprintln(&buf, "// Code generated by mkduff.golang; DO NOT EDIT.")
	fmt.Fprintln(&buf, "// Run golang generate from src/runtime to update.")
	fmt.Fprintln(&buf, "// See mkduff.golang for comments.")
	tags(&buf)
...
func tagsPPC64x(w io.Writer) {
	fmt.Fprintln(w)
	fmt.Fprintln(w, "//golang:build ppc64 || ppc64le")
	fmt.Fprintln(w)
}
...
func tagsMIPS64x(w io.Writer) {
	fmt.Fprintln(w)
	fmt.Fprintln(w, "//golang:build mips64 || mips64le")
	fmt.Fprintln(w)
}
