...
//
// When dynamically linking Golang, it can be returned to from a function
...
// prepGolangExitFrame saves the current TOC pointer (i.e. the TOC pointer for the
...
TEXT runtime·prepGolangExitFrame(SB),NOSPLIT,$0-8
	MOVD    sp+0(FP), R3
	MOVD    R2, 24(R3)
	RET
