...
func genasm386Amd64() {
	...
	buf.WriteString(`// Code generated by wincallback.golang using 'golang generate'. DO NOT EDIT.
...
func gengolang() {
	...
	fmt.Fprintf(&buf, `// Code generated by wincallback.golang using 'golang generate'. DO NOT EDIT.

package runtime

const cb_max = %d // maximum number of windows callbacks allowed
`, maxCallback)
	err := os.WriteFile("zcallback_windows.golang", buf.Bytes(), 0666)
	if err != nil {
		fmt.Fprintf(os.Stderr, "wincallback: %s\n", err)
		os.Exit(2)
	}
