...
TEXT _rt0_loong64_linux_lib(SB),NOSPLIT,$168
	...
	MOVV	_cgolang_sys_thread_create(SB), R19
	BEQ	R19, nocgolang
	MOVV	$_rt0_loong64_linux_lib_golang(SB), R4
	MOVV	$0, R5
	JAL	(R19)
	JMP	restore
...
nocgolang:
	...
	MOVV	$_rt0_loong64_linux_lib_golang(SB), R5
	MOVV	R4, 8(R3)
	MOVV	R5, 16(R3)
...
TEXT _rt0_loong64_linux_lib_golang(SB),NOSPLIT,$0
	MOVV	_rt0_loong64_linux_lib_argc<>(SB), R4
	MOVV	_rt0_loong64_linux_lib_argv<>(SB), R5
	MOVV	$runtime·rt0_golang(SB),R19
	JMP	(R19)
