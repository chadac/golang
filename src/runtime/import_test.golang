...
// This file and importx_test.golang make it possible to write tests in the runtime
...
// because otherwise golang test will complain about Test functions with the wrong
