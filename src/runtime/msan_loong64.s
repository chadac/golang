...
TEXT	runtime·domsanread(SB), NOSPLIT, $0-16
	...
	MOVV	$__msan_read_golang(SB), FARG
	JMP	msancall<>(SB)
...
TEXT	runtime·msanwrite(SB), NOSPLIT, $0-16
	...
	MOVV	$__msan_write_golang(SB), FARG
	JMP	msancall<>(SB)
...
TEXT	runtime·msanmalloc(SB), NOSPLIT, $0-16
	...
	MOVV	$__msan_malloc_golang(SB), FARG
	JMP	msancall<>(SB)
...
TEXT	runtime·msanfree(SB), NOSPLIT, $0-16
	...
	MOVV	$__msan_free_golang(SB), FARG
	JMP	msancall<>(SB)
...
TEXT	runtime·msanmove(SB), NOSPLIT, $0-24
	...
	MOVV	$__msan_memmove_golang(SB), FARG
	JMP	msancall<>(SB)
