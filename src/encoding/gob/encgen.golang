...
// used with golang generate; see the invocation in encode.golang.
...
var output = flag.String("output", "enc_helpers.golang", "file name to write")
...
func main() {
	...
	var b bytes.Buffer
	fmt.Fprintf(&b, "// Code generated by golang run encgen.golang -output %s; DO NOT EDIT.\n", *output)
	fmt.Fprint(&b, header)
	printMaps(&b, "Array")
	fmt.Fprint(&b, "\n")
	printMaps(&b, "Slice")
