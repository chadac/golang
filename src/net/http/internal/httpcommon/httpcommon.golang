...
//golang:generate bundle -prefix= -o=httpcommon.golang golanglang.org/x/net/internal/httpcommon
...
// See golanglang.org/issue/16847
//
// We used to enforce that the path also didn't start with "//", but
// Google's GFE accepts such paths and Chrome sends them, so ignore
// that part of the spec. See golanglang.org/issue/19103.
