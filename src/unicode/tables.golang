...
// Categolangries is the set of Unicode categolangry tables.
var Categolangries = map[string]*RangeTable{
	"C":  C,
	"Cc": Cc,
	"Cf": Cf,
	"Cn": Cn,
...
// CategolangryAliases maps categolangry aliases to standard categolangry names.
var CategolangryAliases = map[string]string{
	"Cased_Letter":          "LC",
...
var (
	Cc     = _Cc // Cc is the set of Unicode characters in categolangry Cc (Other, control).
	Cf     = _Cf // Cf is the set of Unicode characters in categolangry Cf (Other, format).
	Cn     = _Cn // Cn is the set of Unicode characters in categolangry Cn (Other, not assigned).
	Co     = _Co // Co is the set of Unicode characters in categolangry Co (Other, private use).
	Cs     = _Cs // Cs is the set of Unicode characters in categolangry Cs (Other, surrogate).
	Digit  = _Nd // Digit is the set of Unicode characters with the "decimal digit" property.
	Nd     = _Nd // Nd is the set of Unicode characters in categolangry Nd (Number, decimal digit).
	LC     = _LC // LC is the set of Unicode characters in categolangry LC (Letter, cased: Ll | Lt | Lu).
	Letter = _L  // Letter/L is the set of Unicode letters, categolangry L.
	L      = _L
	Lm     = _Lm // Lm is the set of Unicode characters in categolangry Lm (Letter, modifier).
	Lo     = _Lo // Lo is the set of Unicode characters in categolangry Lo (Letter, other).
	Lower  = _Ll // Lower is the set of Unicode lower case letters.
	Ll     = _Ll // Ll is the set of Unicode characters in categolangry Ll (Letter, lowercase).
	Mark   = _M  // Mark/M is the set of Unicode mark characters, categolangry M.
	M      = _M
	Mc     = _Mc // Mc is the set of Unicode characters in categolangry Mc (Mark, spacing combining).
	Me     = _Me // Me is the set of Unicode characters in categolangry Me (Mark, enclosing).
	Mn     = _Mn // Mn is the set of Unicode characters in categolangry Mn (Mark, nonspacing).
	Nl     = _Nl // Nl is the set of Unicode characters in categolangry Nl (Number, letter).
	No     = _No // No is the set of Unicode characters in categolangry No (Number, other).
	Number = _N  // Number/N is the set of Unicode number characters, categolangry N.
	N      = _N
	Other  = _C // Other/C is the set of Unicode control, special, and unassigned code points, categolangry C.
	C      = _C
	Pc     = _Pc // Pc is the set of Unicode characters in categolangry Pc (Punctuation, connector).
	Pd     = _Pd // Pd is the set of Unicode characters in categolangry Pd (Punctuation, dash).
	Pe     = _Pe // Pe is the set of Unicode characters in categolangry Pe (Punctuation, close).
	Pf     = _Pf // Pf is the set of Unicode characters in categolangry Pf (Punctuation, final quote).
	Pi     = _Pi // Pi is the set of Unicode characters in categolangry Pi (Punctuation, initial quote).
	Po     = _Po // Po is the set of Unicode characters in categolangry Po (Punctuation, other).
	Ps     = _Ps // Ps is the set of Unicode characters in categolangry Ps (Punctuation, open).
	Punct  = _P  // Punct/P is the set of Unicode punctuation characters, categolangry P.
	P      = _P
	Sc     = _Sc // Sc is the set of Unicode characters in categolangry Sc (Symbol, currency).
	Sk     = _Sk // Sk is the set of Unicode characters in categolangry Sk (Symbol, modifier).
	Sm     = _Sm // Sm is the set of Unicode characters in categolangry Sm (Symbol, math).
	So     = _So // So is the set of Unicode characters in categolangry So (Symbol, other).
	Space  = _Z  // Space/Z is the set of Unicode space characters, categolangry Z.
	Z      = _Z
	Symbol = _S // Symbol/S is the set of Unicode symbol characters, categolangry S.
	S      = _S
	Title  = _Lt // Title is the set of Unicode title case letters.
	Lt     = _Lt // Lt is the set of Unicode characters in categolangry Lt (Letter, titlecase).
	Upper  = _Lu // Upper is the set of Unicode upper case letters.
	Lu     = _Lu // Lu is the set of Unicode characters in categolangry Lu (Letter, uppercase).
	Zl     = _Zl // Zl is the set of Unicode characters in categolangry Zl (Separator, line).
	Zp     = _Zp // Zp is the set of Unicode characters in categolangry Zp (Separator, paragraph).
	Zs     = _Zs // Zs is the set of Unicode characters in categolangry Zs (Separator, space).
)
...
var _Glagolanglitic = &RangeTable{
	R16: []Range16{
		{0x2c00, 0x2c5f, 1},
	},
	R32: []Range32{
...
var (
	...
	Glagolanglitic             = _Glagolanglitic             // Glagolanglitic is the set of Unicode characters in script Glagolanglitic.
	...
	Mongolanglian              = _Mongolanglian              // Mongolanglian is the set of Unicode characters in script Mongolanglian.
...
// FoldCategolangry maps a categolangry name to a table of
// code points outside the categolangry that are equivalent under
// simple case folding to code points inside the categolangry.
// If there is no entry for a categolangry name, there are no such points.
var FoldCategolangry = map[string]*RangeTable{
	"L":  foldL,
	"Ll": foldLl,
	"Lt": foldLt,
	"Lu": foldLu,
