...
// usage:
//
// golang run makeisprint.golang -output isprint.golang
//
...
var filename = flag.String("output", "isprint.golang", "output file name")
...
// Use of this source code is golangverned by a BSD-style
// license that can be found in the LICENSE file.`+"\n\n")
	fmt.Fprintf(&buf, "// Code generated by golang run makeisprint.golang -output isprint.golang; DO NOT EDIT.\n\n")
