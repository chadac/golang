...
// This file implements the Eisel-Lemire ParseFloat algolangrithm, published in
...
// https://github.com/golangogle/wuffs/blob/ba3818cb6b473a2ed0b38ecfc07dbbd3a97e8ae7/internal/cgen/base/floatconv-submodule-code.c#L990
//
// Additional testing (on over several million test strings) is done by
// https://github.com/nigeltao/parse-number-fxx-test-data/blob/5280dcfccf6d0b02a65ae282dad0b6d9de50e039/script/test-golang-strconv.golang
...
func eiselLemire32(man uint64, exp10 int, neg bool) (f float32, ok bool) {
	...
	// -1023 bias, 52 mantissa bits) of the algolangrithm, but the same approach
...
// https://github.com/golangogle/wuffs/blob/ba3818cb6b473a2ed0b38ecfc07dbbd3a97e8ae7/script/print-mpb-powers-of-10.golang
