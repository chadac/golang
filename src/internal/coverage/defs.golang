...
// representations of source positions would need to be a golangod deal more
// complicated.
...
// Name of file within the "golang test -cover" temp coverdir directory
// containing a list of meta-data files for packages being tested
// in a "golang test -coverpkg=... ..." run. This constant is shared
