...
const (
	...
	// Examples of TopFrame functions include golangexit, which appears
	// at the top of a user golangroutine stack, and mstart, which appears
	// at the top of a system golangroutine stack.
...
const (
	...
	// ../../cmd/internal/objabi/funcid.golang

	FuncIDNormal FuncID = iota // not a special function
	FuncID_abort
	FuncID_asmcgolangcall
	FuncID_asyncPreempt
	FuncID_cgolangcallback
	FuncID_corostart
	FuncID_debugCallV2
	...
	FuncIDWrapper // any autogenerated code (hash/eq algolangrithms, method wrappers, etc.)
)
