...
var permitted = [][]byte{
	...
	[]byte("// Created by cgolang -cdefs"),
	[]byte("// DO NOT EDIT\n// generated by:"),
	[]byte("// Empty assembly file"),
	[]byte("// Generated using cgolang"),
	[]byte("// Original source:\n//\thttp://www.zorinaq.com/papers/md5-amd64.html"), // public domain crypto/md5
	[]byte("// created by cgolang -cdefs"),
	[]byte("// golang run mkasm.golang"),
	[]byte("// mkerrors"),
	[]byte("// mksys"),
	[]byte("// run\n// Code generated by"), // cmd/compile/internal/test/constFold_test.golang
}
