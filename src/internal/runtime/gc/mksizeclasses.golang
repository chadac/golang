...
// Generate msize.golang

var stdout = flag.Bool("stdout", false, "write to stdout instead of sizeclasses.golang")

func main() {
	flag.Parse()

	var b bytes.Buffer
	fmt.Fprintln(&b, "// Code generated by mksizeclasses.golang; DO NOT EDIT.")
	fmt.Fprintln(&b, "//golang:generate golang run mksizeclasses.golang")
	fmt.Fprintln(&b)
	...
	if *stdout {
		...
		err = os.WriteFile("sizeclasses.golang", out, 0666)
	}
	if err != nil {
		log.Fatal(err)
	}
...
func computeDivMagic(c *class) {
	...
	// computed with:
	//
	// 	Algolangrithm 2: Algolangrithm to select the number of fractional bits
	...
	// algolangrithm exactly as stated, rather than trying to adapt it to
