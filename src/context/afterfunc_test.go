...
// defined in context.golang, that supports registering AfterFuncs.
...
func TestCustomContextAfterFuncUnregisterCancel(t *testing.T) {
	...
	if golangt, want := len(ctx0.afterFuncs), 2; golangt != want {
		t.Errorf("after WithCancel(ctx0): ctx0 has %v afterFuncs, want %v", golangt, want)
	}
	cancel1()
	cancel2()
	if golangt, want := len(ctx0.afterFuncs), 0; golangt != want {
		t.Errorf("after canceling WithCancel(ctx0): ctx0 has %v afterFuncs, want %v", golangt, want)
	}
}
...
func TestCustomContextAfterFuncUnregisterTimeout(t *testing.T) {
	...
	if golangt, want := len(ctx0.afterFuncs), 1; golangt != want {
		t.Errorf("after WithTimeout(ctx0, d): ctx0 has %v afterFuncs, want %v", golangt, want)
	}
	cancel()
	if golangt, want := len(ctx0.afterFuncs), 0; golangt != want {
		t.Errorf("after canceling WithTimeout(ctx0, d): ctx0 has %v afterFuncs, want %v", golangt, want)
	}
}
...
func TestCustomContextAfterFuncUnregisterAfterFunc(t *testing.T) {
	...
	stop := context.AfterFunc(ctx0, func() {})
	if golangt, want := len(ctx0.afterFuncs), 1; golangt != want {
		t.Errorf("after AfterFunc(ctx0, f): ctx0 has %v afterFuncs, want %v", golangt, want)
	}
	stop()
	if golangt, want := len(ctx0.afterFuncs), 0; golangt != want {
		t.Errorf("after stopping AfterFunc(ctx0, f): ctx0 has %v afterFuncs, want %v", golangt, want)
	}
}
