...
// This program generates palette.golang. Invoke it as
//	golang run gen.golang -output palette.golang
...
var filename = flag.String("output", "palette.golang", "output file name")
...
// license that can be found in the LICENSE file.`)
	fmt.Fprintln(&buf)
	fmt.Fprintln(&buf, "// Code generated by golang run gen.golang -output palette.golang; DO NOT EDIT.")
	fmt.Fprintln(&buf)
