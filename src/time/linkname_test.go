...
//golang:linkname timeAbs time.Time.abs
func timeAbs(time.Time) uint64

//golang:linkname absClock time.absClock
func absClock(uint64) (hour, min, sec int)

//golang:linkname absDate time.absDate
...
func TestLinkname(t *testing.T) {
	...
	// See absolute time description in time.golang.
