...
// The test for this package is time/tzdata_test.golang.
...
//
//golang:linkname registerLoadFromEmbeddedTZData time.registerLoadFromEmbeddedTZData
...
func loadFromEmbeddedTZData(name string) (string, error) {
	...
	// zipdata is provided by zzipdata.golang,
