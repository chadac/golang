...
// Gen generates sais2.golang by duplicating functions in sais.golang
// using different input types.
// See the comment at the top of sais.golang for details.
package main
...
func main() {
	...
	data, err := os.ReadFile("sais.golang")
	if err != nil {
		log.Fatal(err)
	}
	...
	if err := os.WriteFile("sais2.golang", buf.Bytes(), 0666); err != nil {
		log.Fatal(err)
	}
}
