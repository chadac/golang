...
// was that the call to b.F1(b.T{}) in c.golang would create an itab using
...
// the test case below, at the call to b.F2(b.T{}) in c.golang, the
...
// unit, and the itab construction happens in c.golang.
//
//golang:noinline
func F2(i interface {
	m()
