...
bug331.golang:12: cannot use "hello" (type string) as type float64 in assignment
bug331.golang:12: cannot use 0 (type float64) as type os.Error in assignment:
	float64 does not implement os.Error (missing String method)
bug331.golang:12: error in shape across RETURN
*/
